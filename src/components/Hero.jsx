...
const Hero = () => {
  return (
    <div className='flex rounded-lg p-16 m-10 items-center h-[600px]' id="Hero">
        <div className='font-poppins justify-left text-white w-full ml-[5%]' id='heroText'>
            ...
            <p className='text-sm mt-10'>I'm a senior in University looking to start a career in web development.</p>
